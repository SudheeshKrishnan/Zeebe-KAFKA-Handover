...
@Component
public class VerfyShipGoodsAdapter implements JobHandler {
  ...
  public void handle(JobClient client, ActivatedJob job) {
   ...
   System.out.println("verify goods mode");
    	  messageSender.send(new Message<ShipGoodsCommandPayload>( //
    	            "VerifyShippedGoodsCommand", //
    	            context.getTraceId(), //
    	  ...
    	  map.put("CorrelationId_GoodsVerify", correlationId);
